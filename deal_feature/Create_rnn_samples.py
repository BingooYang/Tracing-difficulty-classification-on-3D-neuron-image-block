...
def save_rnn_seq_sample_txt(data,num):
    ...
    save_path = 'F:\\004Vaa3d\\004feature\\RNN_sample\\' + name
...
def rnn_seq_sample_name(seq):
    ...
    path = 'F:\\004Vaa3d\\004feature\\all_samples_name\\seq_4_rnn_good_sample_name_4.20.txt'
    # 读文本数据
    f = open(path)
    ftextlist = f.readlines()
    re = []
...
def rnn_seq_sample_name_new(seq):
    # path = 'F:\\004Vaa3d\\004feature\\all_samples_name\\all_samples_swc_name_have_label_1.29.txt'
    path = 'F:\\004Vaa3d\\004feature\\all_samples_name\\all_good_tif_samples_name.txt'
    # 读文本数据
    f = open(path)
...
def main():
    ...
    # data = rnn_seq_sample_name_325(seq)
